...
export async function buildTemplateWorkbook(
  ...
  const lines = [
    ...
    "· 생년월일: QR 출석 때 본인 확인에 쓰는 유일한 값입니다. 반드시 채워 주세요.",
    "  비워 두면 그 사람은 명단에서 이름만 눌러도 출석 처리됩니다.",
    "  태어난 월일 네 자리(0315)만 저장하고 연도는 버립니다.",
    "  1990-03-15, 900315 처럼 넣어도 됩니다.",
    "  ※ 엑셀이 0315를 315로 바꾸는 것을 막으려면 칸 서식을 '텍스트'로 두세요.",
    "· 휴대폰: 연락용입니다. 본인 확인에는 쓰지 않습니다.",
